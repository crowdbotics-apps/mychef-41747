"""
Django settings for mychef_41747 project.
...
ROOT_URLCONF = 'mychef_41747.urls'
...
WSGI_APPLICATION = 'mychef_41747.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mychef_41747 API",
    "DESCRIPTION": "API documentation for mychef_41747 App",
    "VERSION": "v1",
}
